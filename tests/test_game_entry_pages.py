...
def _setup_game_with_roster(client, db_session):
    team = Team(
...
def test_add_game_html_creates_draft(client, db_session):
...
def test_game_stats_page_loads_roster(client, db_session):
    game, _ = _setup_game_with_roster(
        client,
        db_session,
    )
